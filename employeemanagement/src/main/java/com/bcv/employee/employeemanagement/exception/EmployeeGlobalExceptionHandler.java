package com.bcv.employee.employeemanagement.exception;
...
public class EmployeeGlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleEmployeeNotFound(Exception ex, WebRequest request){
        EmployeeExceptionResponse employeeExceptionResponse=new EmployeeExceptionResponse(ex.getMessage(), request.getDescription(false),new Date());
